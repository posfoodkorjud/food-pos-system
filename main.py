...
def main():
    ...
    # Configuration
    HOST = os.getenv('HOST', '0.0.0.0')  # Use 0.0.0.0 for cloud deployment
    PORT = int(os.getenv('PORT', os.getenv('FOOD_POS_PORT', 5000)))  # Use PORT env var for cloud platforms
    DEBUG = os.getenv('FLASK_ENV') != 'production'  # Disable debug in production
    AUTO_OPEN = os.getenv('FOOD_POS_AUTO_OPEN', 'False').lower() == 'true'  # Disable auto-open for cloud
